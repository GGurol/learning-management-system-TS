...
app.use("/api/transactions", authMiddleware_1.protect, transactionRoutes_1.default);
app.use("/api/users/course-progress", authMiddleware_1.protect, userCourseProgressRoutes_1.default);
/* SERVER */
